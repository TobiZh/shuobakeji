...
public class Sign {
	...
	public static void main(String[] args){
	    long appId=1253604429;
	    String secretId="AKIDHPJVYOJMVR9ew2id8RVLxMXXIsHSn9gy";
	    String secretKey="DDzXpvoSqysX0MvIRL1byMXWHo6D7nER";
	    String bucketName="songsong";
	    long expired=300000;
        try {
            String key=appSign(appId,secretId,secretKey,bucketName,expired);
